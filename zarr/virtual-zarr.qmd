...
For icechunk, the user explicitly specifies the authentication mechanism required for both the archival data loaction and icechunk location. This makes the syntax more verbose:
