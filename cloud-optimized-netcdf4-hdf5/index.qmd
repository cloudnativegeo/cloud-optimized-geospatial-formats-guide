...
To estimate the uncompressed size, multiple the dimensions of the chunk by the number of bytes or the given data type. For example, given 3 dimensional chunks of 10x100x100 and a data type of `float64` (8 bytes), each uncompresed chunk will be 0.8 MB.
...
1. **Compression variabiliaty:** Because of data variability, you cannot deterministically know the size of each compressed chunk.
