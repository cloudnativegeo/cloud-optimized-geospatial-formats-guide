...
* Zarr V3 was accepted as a spec in 2023. Its community adoption is accelerating.
...
* The [GeoZarr spec](https://github.com/zarr-developers/geozarr-spec) defines conventions for organizing geospatial data in a Zarr store. Specifically, the spec defines conventions for Zarr DataArray and DataSet metadata and organization of associated data to be conformant as GeoZarr archive. The spec remains in development.
* [Icechunk](https://icechunk.io/en/stable/) provides features including data version control and serializable isolation on top of Zarr.
