...
<!-- note to self, add to downsides: FlatGeobuf indexes _every single object_, which leads to very large spatial indexes as the number of the rows in the file grows large. -->
