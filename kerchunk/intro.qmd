...
Kerchunk's potential utility to the geospatial data community cannot be understated. Kerchunk enables cloud-optimized access to traditional geospatial file formats, like NetCDF, potentially negating the need to create and store copies of data for cloud-optimized access.
...
It is burdensome to create and maintain copies of data. The other pages in this guide introduce data formats which require processing and creating new data products. This process of creating and maintaining new data products which are copies of data that already exists can be burdensome and costly for data providers. Kerchunk provides a method of providing cloud-optimized access to data that is more traditional archival formats.
