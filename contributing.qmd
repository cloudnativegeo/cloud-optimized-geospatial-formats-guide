...
3. Optionally, add a notebook with examples of creating and accessing (via the cloud) a file of that format.
...
## 4. Add yourself to the list of authors on the [Welcome](./index.qmd#authors) page!

## 5. Once your PR is approved, merge away.
