...
2. Link to the `intro.qmd` page in the `index.qmd` file and `_quarto.yml` table of contents.
3. Optionally, add a notebook with an examples of creating and cloud-optimized access of a file of that format.
