...
Please cite the Cloud Optimized Geospatial Formats Guide through the project’s Zenodo archive using its DOI: [https://doi.org/10.5281/zenodo.15498528](https://doi.org/10.5281/zenodo.15498528).
...
Please visit the Guide's [DOI link](https://doi.org/10.5281/zenodo.15498528) to get the most recent version - the one above is not automatically generated and may be out of date as we release updated versions of the Guide.
