...
2. [Format Selection Decision Framework](./decision-framework/index.qmd)
   a. [Case Studies](./decision-framework/case-studies.qmd)
3. Formats
   ...
   d. [Cloud-Optimized Point Clouds (COPC)](./copc/index.qmd)
   e. [GeoParquet](./geoparquet/index.qmd)
   f. [FlatGeobuf](./flatgeobuf/intro.qmd)
   g. [PMTiles](./pmtiles/intro.qmd)
4. [Cookbooks](./cookbooks/index.qmd)
...
* [Emmanuel Mathot](https://developmentseed.org/team/emmanuel-mathot)
