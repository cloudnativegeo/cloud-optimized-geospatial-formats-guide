...
Usually refers to services hosted by [Amazon](#amazon-web-services-aws), [Google](#google-cloud), or [Microsoft](#microsoft-azure).
...
An extension of [TIFF](#tagged-image-file-format-tiff) to store geospatially-referenced image data. Includes extra information such as the [coordinate reference system](#coordinate-reference-system-crs) and [geotransform](#geotransform).
...
A file format for image data that supports [lossless compression](#lossless-compression).
